        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {/* First Instagram embed */}
              <div className="col-span-1">
                <blockquote 
                  className="instagram-media" 
                  data-instgrm-captioned 
                  data-instgrm-permalink="https://www.instagram.com/p/DJmoJ7LOBkF/?utm_source=ig_embed&utm_campaign=loading" 
                ...
                >
                  <div style={{ padding: '16px' }}>
                    <a 
                      href="https://www.instagram.com/p/DJmoJ7LOBkF/?utm_source=ig_embed&utm_campaign=loading" 
                      style={{ 
                        background: '#FFFFFF', 
                        lineHeight: 0, 
                        padding: '0 0', 
                    ...
                    <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      <a href="https://www.instagram.com/p/DJmoJ7LOBkF/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank">A post shared by Your Favorite Detailer (@your.favorite.detailer)</a>
                    </p>
                  </div>
                </blockquote>
              </div>
              ...
              {Array.from({ length: 8 }, (_, i) => (
                ...
                >
                  <div className="w-full h-full bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center group-hover:from-primary/30 group-hover:to-accent/30 transition-colors">
                    <span className="text-muted-foreground text-sm">Recent Work {i + 2}</span>
                  </div>
                </div>
              ))}
            </div>
